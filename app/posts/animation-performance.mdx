...
<image title="" src="/assets/blog/animation-performance/02.gif" />
...
<image title="" src="/assets/blog/animation-performance/03.png" />
...
Vậy nên cách tốt nhất để tăng hiệu năng cho animation, là cố gắng giảm cost cho browser nhiều nhất có thể. Các bạn có thể xem ví dụ sau để hiểu rõ hơn:

<browser
  title="Ví dụ về hiệu năng của animation"
  src="https://jsfiddle.net/monodyle/c4v6jzf3/embedded/"
/>
